...
class FirebasePhoneAuth {
  ...
  static var _authCredential, actualCode, phone, status,cont;
  ...
  static instantiate({String phoneNumber,BuildContext c}) async {
...
//    phoneAuthState.close();
  ...
  static onAuthenticationSuccessful() {
    ...
    //showtoast("Verification success", Colors.black);
